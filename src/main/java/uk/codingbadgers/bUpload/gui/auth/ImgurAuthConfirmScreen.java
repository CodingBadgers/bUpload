...
public class ImgurAuthConfirmScreen extends bUploadGuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        drawCenteredString(this.fontRendererObj, TranslationManager.getTranslation("image.confirm.ln1", EnumChatFormatting.GOLD + ImgurAuthHandler.getInstance().getUsername()), this.width / 2, this.height / 6 + 42, 0xFFFFFF);
