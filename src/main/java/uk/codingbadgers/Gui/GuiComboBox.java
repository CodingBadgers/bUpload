...
public class GuiComboBox extends Gui {
    ...
    public void drawGuiComboBox(Minecraft minecraft, int mouseX, int mouseY) {
        ...
        drawString(minecraft.fontRenderer, this.items.get(getSelectedItem()), x + 6, y + fontHeight + 6, hoverColor);
    }
    ...
    public void drawPopup(Minecraft mc, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < this.items.size(); i++) {
            ...
            drawString(mc.fontRenderer, this.items.get(i), xPos + 6, yPos + 6, hoverColor);
